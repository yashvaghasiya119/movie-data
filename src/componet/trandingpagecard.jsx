            ...
            data ? data.map((cur,index)=>{
                return <NavLink to={`/${cur.media_type ||title}/details/${cur.id}`} key={index}>
                    <div  className="s-tranding-loop">
                        <img src={ cur.backdrop_path || cur.poster_path || cur.profile_path? `https://image.tmdb.org/t/p/original/${cur.backdrop_path || cur.poster_path || cur.profile_path}` : noimg} alt="" />
